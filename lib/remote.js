 ...
 *   downloadSource(id, channel<'github'|'cdn'>, rev)       → SourcesSnapshot
 *   updateSource(id, channel<'github'|'cdn'>, rev)         → SourcesSnapshot
...
function buildMethods() {
  return {
    ...
    async downloadSource(id, channel, expectedRevision) {
      return remoteDownloadSource(resolveTargetDir(), id, channel, expectedRevision, { update: false })
    },
    async updateSource(id, channel, expectedRevision) {
      return remoteDownloadSource(resolveTargetDir(), id, channel, expectedRevision, { update: true })
    },
